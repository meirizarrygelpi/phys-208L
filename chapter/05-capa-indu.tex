...
\begin{itemize}
    \item Run 1: $R = 10$ ohm, one inductor without metallic core.
    \item Run 2: $R = 10$ ohm, one inductor with metallic core.
    \item Run 3: $R = 10$ ohm, two inductors in series without metallic cores.
    \item Run 4: $R = 10$ ohm, two inductors in series with metallic cores.
\end{itemize}
...
\begin{itemize}
    ...
    \item Run 3: Two $R = 10$ ohm resistors in parallel, and one inductor without metallic core.
    \item Run 4: Two $R = 10$ ohm resistors in parallel, and one inductor with metallic core.
    \item Run 5: One $R = 10$ ohm resistor, and two inductors in series without metallic core.
    \item Run 6: One $R = 10$ ohm resistor, and two inductors in series with metallic core.
